...
def get_file_text(file_contents):
    ...
    elif extension in [".txt", ".csv", ".doc", ".docx",".xls"]:
...
def get_vectorstore(text_chunks):
    try:
        embeddings = OpenAIEmbeddings(openai_api_key="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")
...
def get_conversation_chain(vectorstore):
    llm = ChatOpenAI(openai_api_key="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")
