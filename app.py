...
def get_vectorstore(text_chunks):
    try:
        embeddings = OpenAIEmbeddings(openai_api_key="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")
...
def get_conversation_chain(vectorstore):
    llm = ChatOpenAI(openai_api_key="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")
