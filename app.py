...
def get_vectorstore(text_chunks):
    try:
        embeddings = OpenAIEmbeddings(openai_api_key="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")
...
def get_conversation_chain(vectorstore):
    llm = ChatOpenAI(openai_api_key="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")
